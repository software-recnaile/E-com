...
//
//        // Validate addresses
//        validateAddress(userId, shippingAddressId);
//        validateAddress(userId, billingAddressId);
//
...
//        order.setDeliveryDate(LocalDateTime.now().plusDays(3)); // Default 3 days delivery
...
public class OrderService {
    ...
    public Order placeOrder(String userId, List<OrderRequest.Item> items,
        ...
        if (!addressService.verifyAddressBelongsToUser(userId, shippingAddressId)) {
