...
//            @Qualifier("accountMongoTemplate") MongoTemplate mongoTemplate,
...
//            log.info("Successfully saved order with reference ID: {}", referenceId);
...
//            log.error("Failed to save to MongoDB for order: {}", referenceId, e);
